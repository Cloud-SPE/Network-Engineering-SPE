...
- owner, status, and approving decision;
- user and outcome;
- scope and explicit non-goals;
- interfaces and affected repositories;
- measurable acceptance evidence;
- dependencies and unresolved decisions; and
- review date and change history.

Use Beads to track specification work and dependencies; do not add status
checklists to specification files.
